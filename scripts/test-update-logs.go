...
func main() {
	...
	// log.Event(ctx, , log.Error(error))
	log.Error(err, nil)

	// log.Event(ctx, , log.Error(error), logData)
	log.Error(err, logData)

	// log.Event(ctx, , log.Error(error), log.Data{"data_1": data1})
	log.Error(err, log.Data{"data_1": data1})

	// log.Event(ctx, "message", log.Error(error), log.Data{"data_1": data1, "data_2": data2})
	log.ErrorC("message", err, log.Data{"data_1": data1, "data_2": data2})

	// log.Event(ctx, message1, log.Error(error), log.Data{"data_1": data1, "data_2": data2})
	...
	// log.Event(ctx, "message", log.Error(error), log.Data{"data-1": data1, "data-2": data2})
	...
	// log.Event(ctx, "message", log.Error(error), log.Data{"data-1": data1, "data-2": data2, "data-3": data3, "data-4": data4})
