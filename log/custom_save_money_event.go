...
// CustomSaveMoneyEvent1 for use in middleware to replace the log.Event
func CustomSaveMoneyEvent1(ctx context.Context, event string,
...
// CustomSaveMoneyEvent2 for use in dp-frontend-router createReverseProxy()
// to replace the log.Event
func CustomSaveMoneyEvent2(ctx context.Context, event string, info severity,
	req *http.Request, statusCode int, responseContentLength int64,
...
// CustomSaveMoneyEvent3 for use in middleware to replace the 2nd log.Event
func CustomSaveMoneyEvent3(ctx context.Context, event string,
	req *http.Request, statusCode int, responseContentLength int64,
	startedAt, endedAt *time.Time) {
