...
// IntermediaryEvent1 for use in middleware to replace the 1st log.Event
func IntermediaryEvent1(ctx context.Context, event string, opts ...option) {
...
// IntermediaryEvent2 for use in dp-frontend-router to replace log.Event in
// function: createReverseProxy()
func IntermediaryEvent2(ctx context.Context, event string, opts ...option) {
	// Minimum Allocations Event code ...
	e := EventData2{
		CreatedAt: time.Now().UTC(),
		Namespace: Namespace,
...
// IntermediaryEvent3 for use in middleware to replace the 2nd log.Event
func IntermediaryEvent3(ctx context.Context, event string, opts ...option) {
	// Minimum Allocations Event code ...
	e := EventData2{
		CreatedAt: time.Now().UTC(),
		Namespace: Namespace,
