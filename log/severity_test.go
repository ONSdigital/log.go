...
func TestSeverity(t *testing.T) {
	Convey("A severity can be attached to *EventData", t, func() {
		event := &EventData{}
	...
	Convey("All severity values are of type severity", t, func() {
	...
	Convey("All severity values match logging spec", t, func() {
